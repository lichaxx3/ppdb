        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-color">Pengumuman</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="/admin/data_pengumuman_delete"
                    ...
                    <div class="modal fade" id="tambah_pengumuman" tabindex="-1" aria-labelledby="exampleModalLabel"
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="/admin/data_pengumuman_tambah" enctype="multipart/form-data"
                                        method="POST">
                                        @csrf
                                        <div class="form-group">
